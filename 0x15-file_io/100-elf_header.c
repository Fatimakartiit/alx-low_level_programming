 ...
 * @e_ident: pointer to array contains elf magic numbers.
 *
 ...
 * @e_ident: pointer to array containing the elf magic number.
 *
 ...
 *   * @e_ident: pointer to array contains elf version.
 *    */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: pointer to array contains the elf ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_ident: pointer to array contains the elf class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main - Display information containing the
